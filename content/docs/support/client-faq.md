...
The FiveM client can run on Linux but without anticheat, so you will not be able to connect to most servers. You can make your own server for you and your friends, just remember to disable svadhesive. 
